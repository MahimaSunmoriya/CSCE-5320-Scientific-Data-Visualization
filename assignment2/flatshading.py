...
surf.actor.property.interpolation = 'flat'   # for flat shading of plot we must select imterpolation as flat 
surf.actor.property.specular = 0.1
surf.actor.property.specular_power = 5

## lets plot the fucntion on mlab version of mayavi
mlab.title('Falt shading on superimposed plot of 30*30 grid domain')
mlab.savefig('flat shading superimposed 30by30.png')
mlab.show()